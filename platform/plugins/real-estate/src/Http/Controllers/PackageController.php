...
use Botble\RealEstate\Http\Requests\PackageAddRequest;
...
class PackageController extends BaseController
{
    ...
    /**
     * @param PackageAddRequest $request
     ...
     * @return BaseHttpResponse
     */
    public function update($id, PackageAddRequest $request, BaseHttpResponse $response)
    {
        $package = $this->packageRepository->findOrFail($id);
