...
class PostRepository extends RepositoriesAbstract implements PostInterface
{
     ...
     * {@inheritDoc}
     */
    public function getAllPosts($perPage = 12, $active = true, array $with = ['slugable'], $keyword = '')
    {
        $data = $this->model
            ->with($with)
            ->withCount(['reviews'])
     ...
     * {@inheritDoc}
     */
    public function getPost(array $condition = [], array $with = []) {
        $params = [
            'condition' => $condition,
            'with'      => $with,
            'withCount' => ['reviews'],
     ...
     * {@inheritDoc}
     */
    public function getPostsByConditions(array $condition, $limit, array $with = [], array $withCount = [], array $orderBy = [], $paginate = [])
    {
        $params = [
            'condition' => $condition,
            'with'      => $with,
