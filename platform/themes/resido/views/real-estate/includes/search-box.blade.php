                ...
                <div class="row ml-md-0 mr-md-0">
                    ...
                    @if ($type == 'property')
                        <div class="col-lg-2 col-md-4 px-1 mb-2">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuPrice" data-bs-toggle="dropdown"
                        ...
                        <div class="col-lg-2 col-md-4 px-1 mb-2">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuSquare" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                    ...
                    @else
                        ...
                        <div class="col-lg-2 col-md-4 px-1">
                            ...
                            <div class="dropdown mb-2">
                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuFlat" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <span>{{ __('All squares') }}</span>
                                </button>
