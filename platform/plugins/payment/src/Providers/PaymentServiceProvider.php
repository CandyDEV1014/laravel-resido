...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        add_shortcode('payment-detail', __('Payment detail'), __('Payment detail'), function ($shortCode) {
            $package_id = $shortCode->package_id;

            $package = app(PackageInterface::class)->findOrFail($package_id);

            $view = 'plugins/payment::partials.payment-detail';
        ...
        shortcode()->setAdminConfig('payment-detail', function ($attributes) {
            return view('plugins/payment::partials.payment-detail-admin-config', compact('attributes'))->render();
        });
