...
Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    if (defined('THEME_MODULE_SCREEN_NAME')) {
        Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
            ...
            Route::get('top-properties', 'PublicController@getTopProperties')->name('public.topProperty');

            Route::get('new-properties', 'PublicController@getNewProperties')->name('public.newProperty');

            Route::get('featured-properties', 'PublicController@getFeaturedProperties')->name('public.featuredProperty');
            ...
            Route::group(['middleware' => ['account'], 'as' => 'public.account.'], function () {
                Route::group(['prefix' => 'account'], function () {
                    ...
                    Route::get('my-review', [
                        'as'   => 'myReview',
                        'uses' => 'PublicAccountController@myReview',
                    ]);

                    Route::get('my-review/edit/{id}', [
                        'as'   => 'editMyReview',
                        'uses' => 'PublicAccountController@editMyReview',
                    ]);

                    Route::get('my-review/delete/{id}', [
                        'as'   => 'deleteMyReview',
                        'uses' => 'PublicAccountController@deleteMyReview',
                    ]);

                    Route::get('client-review', [
                        'as'   => 'clientReview',
                        'uses' => 'PublicAccountController@clientReview'
                    ]);
                ...
                Route::group(['prefix' => 'account/properties', 'as' => 'properties.'], function () {
                    ...
                    Route::post('get/{id}', [
                        'as'   => 'get',
                        'uses' => 'AccountPropertyController@getProperty',
                    ]);
                    Route::post('renew/{id}', [
                        'as'   => 'renew',
